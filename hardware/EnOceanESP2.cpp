...
const _t4BSLookup T4BSTable[] = {
	...
	{ 0xD2, 0x01, 0x0C, "Electronic switch with Local Control",																	"PilotWire" },
	...
	{ 0xD2, 0x03, 0x0A , "Push Button – Single Button"          ,																"Switch" },
	{ 0xD2, 0x05, 0x00 , "Blinds Control for Position and Angle",																"BlindsControl" },
	{ 0xD2, 0x05, 0x01 , "Blinds Control for Position and Angle",																"BlindsControl" },
	{ 0xD2, 0x05, 0x02 , "Blinds Control for Position and Angle",																"BlindsControl" },
	{ 0xF6, 0x01, 0x01 , "Push Button"                          ,																"Push"   },
	{ 0xF6, 0x02, 0x01 , "Rocker Switch, 2 Button"              ,																"Rocker" },
	{ 0xF6, 0x02, 0x02 , "Rocker Switch, 2 Button"              ,																"Rocker" },
	{ 0xF6, 0x02, 0x03 , "Rocker Switch, 2 Button"              ,																"Rocker" },
	{ 0xF6, 0x02, 0x04 , "Rocker Switch, 2 Button"              ,																"Rocker" },
	{ 0xF6, 0x03, 0x01 , "Rocker Switch, 4 Button"              ,																"Rocker" },
	{ 0xF6, 0x03, 0x02 , "Rocker Switch, 4 Button"              ,																"Rocker" },
	{ 0xF6, 0x04, 0x01 , "Position switch "                     ,																"Detector" },
	{ 0xF6, 0x04, 0x02 , "Position switch "                     ,																"Detector" },
	{ 0xF6, 0x05, 0x00 , "Detectors"                            ,																"Detector" },
	{ 0xF6, 0x05, 0x01 , "Detectors"                            ,																"Detector" },
	{ 0xF6, 0x05, 0x02 , "Detectors"                            ,																"Detector" },
	{ 0xF6, 0x10, 0x00 , "Mechanical Handle"                    ,																"Detector" },
	{ 0xF6, 0x10, 0x01 , "Mechanical Handle"                    ,																"Detector" },
